    ...
    render() {
        ...
        return (
            <div className="pick">
                ...
                <small>{new Date(pick.timestamp).toLocaleString()}</small> | <b>{pick.multiplier}</b> = {pick.forPurchaseMultiplier} + {pick.pmAnalysisMultiplier} + {pick.subsetOffsetMultiplier}
                <hr/>
                {fiveDay && (
                  <i>
